...
function save(): PlayerSave {
  return { schemaVersion: 5, id: "s", playerName: "P", createdAt: "", updatedAt: "", currentCampaignId: "via-prima", currentChapterId: "prologus", currentQuestId: "prologus_main_prima", currentSceneId: "prologus_001_arrival", level: 1, xp: 0, currency: 0, streak: { current: 0, best: 0 }, masteryStates: [], seenRewardEventIds: [], flags: {}, inventory: [], skills: [], questStates: {}, completedSceneIds: [], visitedSceneIds: [], journalEntries: [], dialogueLog: [], eventLog: [], npcMemories: [], locationStates: [], worldEvents: [], activeSideQuestSuggestions: [], narrativeFlags: {}, generatedQuests: [], assessmentAttempts: [], achievements: [], analyticsSnapshots: [], chapterProgress: {} };
}
...
test("CampaignProgressSystem calculates scene progress", () => {
  ...
  assert.ok(campaign);
  const current = save();
  current.completedSceneIds = ["prologus_001_arrival", "prologus_002_practice"];
  const progress = new CampaignProgressSystem().getChapterProgress(current, campaign, "prologus");
